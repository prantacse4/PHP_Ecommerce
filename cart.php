...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Shopping Cart || PHOTOGRAPHY PRODUCTS SHOP</title>
  ...
  <body>
    ...
    <nav class="top-bar" data-topbar role="navigation">
      <ul class="title-area">
        <li class="name">
          <h1><a href="index.php">PHOTOGRAPHY PRODUCT SHOP</a></h1>
        </li>
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        ...
        <footer style="margin-top:10px;">
           <p style="text-align:center; font-size:0.8em;clear:both;">&copy; PHOTOGRAPHY PRODUCTS SHOP. All Rights Reserved.</p>
        </footer>
